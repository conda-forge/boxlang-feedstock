...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/boxlang-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13379&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/boxlang-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `boxlang` can be installed with:

```
conda install boxlang
```

It is possible to list all of the versions of `boxlang` available on your platform with:
